...
urlpatterns = [
    ...
    # Shipping
    path('shipping/methods/', views.ShippingMethodListView.as_view(), name='shipping_methods'),
    ...
    path('vendor/earnings/summary/', views.vendor_earnings_summary, name='vendor_earnings_summary'),
